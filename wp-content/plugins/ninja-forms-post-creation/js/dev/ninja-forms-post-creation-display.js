jQuery(document).ready(function(jQuery) {
	...
	jQuery(document).on( 'click', '.ninja-forms-del-tag', function(e){
		e.preventDefault();
	...
	jQuery(document).on( 'click', '.ninja-forms-terms-tab', function(e){
		e.preventDefault();
	...
	jQuery(document).on( 'change', '.cat-checkbox', function(){
