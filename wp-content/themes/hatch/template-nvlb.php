...
<main role="main">
  ...
  <div class="nvlb-hero">
    <img alt="No Vote Left Behind" src="<?php echo get_template_directory_uri(); ?>/dist/asset/img/nvlb-header.jpg">
  </div>
  ...
  <div style="margin: 60px 0;">
    <div class="container">
      <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/472750755" frameborder="0" allow="autoplay; fullscreen" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>
    </div>
  </div>
        ...
        <div class="col-md-12">
          ...
          <div class="resources-wrapper">
            <a class="resource" target="_blank" href="https://www.vote.org/">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/asset/img/nvlb-tile-1.jpg">
            ...
            <a class="resource" target="_blank" href="https://hatchexperience.org/no-votes-left-behind-featured-guests/">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/asset/img/nvlb-tile-2.jpg">
            ...
            <a class="resource" target="_blank" href="https://hatchexperience.org/vote-partners/">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/asset/img/nvlb-tile-3.jpg">
